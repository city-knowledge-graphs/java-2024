...
public class CompareWithReference {
	...
	public static void main(String[] args) {
		//Anatomy
		new CompareWithReference("files/lab8/anatomy-reference-mappings.ttl", "files/lab8/anatomy-example-system-mappings.ttl");
		
		//Pizza
		new CompareWithReference("files/lab8/reference-mappings-pizza.ttl", "files/lab8/system-mappings-pizza.ttl");
